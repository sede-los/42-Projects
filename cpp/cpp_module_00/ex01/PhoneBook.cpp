...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/27 08:41:36 by sergio            #+#    #+#             */
/*   Updated: 2025/10/27 08:41:38 by sergio           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	PhoneBook::SetContactId(int id, std::string First, std::string Last, std::string Nick, std::string Phone, std::string Secret)
{
